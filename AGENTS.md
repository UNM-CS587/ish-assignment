...
general Unix command shell. This repository includes testing infrastructure 
(in the class-tests and tests directories) which you should use to verify
the correectness of any added code. DO NOT CHANGE THE TEST in the class-tests
directory!
